...
function validate() {
	...
	// ---------------------------------------------
	if (document.myForm.phone.value == '' || isNaN(document.myForm.phone.value) || document.myForm.phone.value.length != 7) {
		warning.innerHTML = '* Skriv inn et gyldig 7-sifret telefonnummer';
